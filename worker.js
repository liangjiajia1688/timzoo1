/**
 * TimZoo 探店管理 - Cloudflare Workers 后端
 *
 * 部署方式: Cloudflare Pages Functions + D1 数据库
 * 将此文件放在 /functions 目录下，Pages 会自动识别为 Worker路由
 * 或者通过 wrangler deploy 部署为独立 Worker
 */
